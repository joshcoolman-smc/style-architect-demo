...
const TypographySpecimen = () => {
  ...
  return (
    <div className="space-y-16 text-left">
      ...
      <GradientContainer className="p-12">
        <h2 className="text-2xl md:text-3xl font-bold border-b border-neutral-600 pb-2 mb-6 text-white">Font Families</h2>
      ...
      {/* Type Scale */}
      <GradientContainer className="p-12">
        <h2 className="text-2xl md:text-3xl font-bold border-b border-neutral-600 pb-2 mb-6 text-white">Type Scale</h2>
      ...
      {/* Paragraph Styles */}
      <GradientContainer className="p-12">
        <h2 className="text-2xl md:text-3xl font-bold border-b border-neutral-600 pb-2 mb-6 text-white">Paragraph Styles</h2>
        <div className="space-y-4 max-w-prose mt-6">
          <p className="text-lg font-content text-neutral-200">
          ...
          <p className="text-sm text-neutral-400 font-content">
